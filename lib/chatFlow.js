...
export function shouldTriggerItinerary(conversationData) {
  ...
  // Quick plan mode - minimal info needed but MUST include transportation (safety!)
  ...
  if (hasQuickPlanKeywords && 
      conversationData.groupSize && 
      conversationData.winePreferences &&
      conversationData.transportation) { // ADDED: Must have DD plan!
    return true;
  }
